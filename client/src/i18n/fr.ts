...
export const fr: Translation = {
  ...
  tutorial: {
    ...
    rankedTitle:        'Classement en ligne',
    rankedCounts:       'Partie classée (Ranked)',
    rankedCountsDesc:   'Modifie ton rang.',
    rankedNoCounts:     'Local · IA · Casual',
    rankedNoCountsDesc: 'Aucun impact sur le classement.',
    tierUnranked:       'Non classé',
    rankedPlacement:    'Matchs de placement',
    rankedPlacementDesc:'10 parties pour calibrer ton niveau. Les écarts de MMR sont amplifiés.',
    rankedLp:           'Gagner des LP',
    rankedLpDesc:       '+20 à +35 LP par victoire selon la force de l\'adversaire. −15 à −25 en cas de défaite.',
    rankedPromo:        'Séries de promotion',
    rankedPromoDesc:    'À 100 LP en palier I : gagne 3 parties sur 5 pour monter au rang suivant.',
