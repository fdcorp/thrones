...
export const en: Translation = {
  ...
  tutorial: {
    ...
    rankedTitle:        'Online ranking',
    rankedCounts:       'Ranked match',
    rankedCountsDesc:   'Affects your rank.',
    rankedNoCounts:     'Local · AI · Casual',
    rankedNoCountsDesc: 'No ranking impact.',
    tierUnranked:       'Unranked',
    rankedPlacement:    'Placement matches',
    rankedPlacementDesc:'10 games to calibrate your level. MMR swings are amplified.',
    rankedLp:           'Earning LP',
    rankedLpDesc:       '+20 to +35 LP per win based on opponent strength. −15 to −25 on loss.',
    rankedPromo:        'Promotion series',
    rankedPromoDesc:    'At 100 LP in division I: win 3 out of 5 to advance to the next tier.',
